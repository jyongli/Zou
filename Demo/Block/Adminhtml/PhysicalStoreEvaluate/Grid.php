...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        parent::_construct();
        $this->setId('physicalStoreEvaGrid');
    ...
    {
        $collection = $this->_physicalStoreEvaluateCollectionFactory->create();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'auditResult',
            [
                'header' => __('auditResult'),
                'index' => 'auditResult',
                'class' => 'xxx',
                'type' => 'options',
                'options' => Status::getPassLable(),
                'width' => '50px',
            ]
            );
        $this->addColumn(
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('physicalStoreEvaluate');
